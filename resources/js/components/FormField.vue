  ...
  <div>
    <div class="card mb-6 overflow-hidden">
      <div class="flex w-2/3 justify-between px-8 pt-4">
        ...
        >Le Adjust an existing mail template or craft an email from scratch! You can use normal blade syntax and include attributes from this resources model&hellip;</div>
      </div>
